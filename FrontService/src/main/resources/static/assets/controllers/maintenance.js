angular.module('fitness').controller('maintenanceController', function ($scope, $http, $localStorage) {
    const contextPathMaintenance = 'http://localhost:3881/fitness/api/v1';
